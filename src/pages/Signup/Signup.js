...
if(userEmailArray.includes(signUpDetails.email)){toast.error("Email Alread Registered");return}
      ...
      <div className={styles.container}>
        <div className={styles.left}>
          ...
          <div className={styles.loginForm}>
            <input onChange={handleInputChange} className={styles.input} type="text" placeholder='Your Email' name='email' value={signUpDetails.email} />
